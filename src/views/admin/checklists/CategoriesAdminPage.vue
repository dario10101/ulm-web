...
import { ArrowLeft, ArrowDown, ArrowUp, Plus, Trash2 } from '@lucide/vue'
import { computed, onMounted, ref } from 'vue'

import BaseButton from '@/components/ui/BaseButton.vue'
import BaseCard from '@/components/ui/BaseCard.vue'
import { ApiError } from '@/lib/http'
import { listCategories, replaceCategories } from '@/services/checklistsApi'
...
<template>
  <div class="space-y-6">
    ...
    <BaseCard title="Categories">
      ...
      <template v-else>
        <p v-if="!draft.length" class="py-6 text-center text-sm text-muted">
